...
```typescript
import { DtoCancelScheduleRequest } from "openapi/models";
...
| `scheduleType`                                                                                               | [models.TypesSubscriptionScheduleChangeType](../models/types-subscription-schedule-change-type.md)           | :heavy_minus_sign:                                                                                           | N/A                                                                                                          |

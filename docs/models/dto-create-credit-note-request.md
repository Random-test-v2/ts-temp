...
```typescript
import { DtoCreateCreditNoteRequest } from "openapi/models";
...
| `lineItems`                                                                                          | [models.DtoCreateCreditNoteLineItemRequest](../models/dto-create-credit-note-line-item-request.md)[] | :heavy_minus_sign:                                                                                   | line_items contains the individual line items that make up this credit note (minimum 1 required)     |
...
| `reason`                                                                                             | [models.TypesCreditNoteReason](../models/types-credit-note-reason.md)                                | :heavy_check_mark:                                                                                   | N/A                                                                                                  |
...
```typescript
import { DtoCostAnalyticItem } from "openapi/models";
...
| ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- | ---------------------------------------------------- |
| `costByPeriod`                                       | [models.DtoCostPoint](../models/dto-cost-point.md)[] | :heavy_minus_sign:                                   | Breakdown                                            |
...
| `meter`                                              | [models.MeterMeter](../models/meter-meter.md)        | :heavy_minus_sign:                                   | N/A                                                  |

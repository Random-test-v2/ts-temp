...
```typescript
import { DtoCreateTaxRateRequest } from "openapi/models";
...
| `scope`                                                                               | [models.TypesTaxRateScope](../models/types-tax-rate-scope.md)                         | :heavy_minus_sign:                                                                    | N/A                                                                                   |
| `taxRateType`                                                                         | [models.TypesTaxRateType](../models/types-tax-rate-type.md)                           | :heavy_minus_sign:                                                                    | N/A                                                                                   |
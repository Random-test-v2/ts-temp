...
```typescript
import { DtoCustomerMultiCurrencyInvoiceSummary } from "openapi/models";
...
| `summaries`                                                                     | [models.DtoCustomerInvoiceSummary](../models/dto-customer-invoice-summary.md)[] | :heavy_minus_sign:                                                              | summaries contains the invoice summaries for each currency                      |
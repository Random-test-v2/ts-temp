...
```typescript
import { DtoGetDetailedCostAnalyticsResponse } from "openapi/models";
...
| ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `costAnalytics`                                                     | [models.DtoCostAnalyticItem](../models/dto-cost-analytic-item.md)[] | :heavy_minus_sign:                                                  | Cost analytics array (flattened from nested structure)              |

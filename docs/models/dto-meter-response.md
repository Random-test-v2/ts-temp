...
```typescript
import { DtoMeterResponse } from "openapi/models";
...
| --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------- |
| `aggregation`                                             | [models.MeterAggregation](../models/meter-aggregation.md) | :heavy_minus_sign:                                        | N/A                                                       |                                                           |
...
| `resetUsage`                                              | [models.TypesResetUsage](../models/types-reset-usage.md)  | :heavy_minus_sign:                                        | N/A                                                       |                                                           |

...
/** @internal */
export const DtoSubscriptionResponseV2$inboundSchema: z.ZodMiniType<
...
> = z.pipe(
  z.object({
    ...
    commitment_duration: types.optional(TypesBillingPeriod$inboundSchema),
    ...
    line_items: types.optional(
      z.array(DtoSubscriptionLineItemResponse$inboundSchema),
    ),
    ...
    payment_terms: types.optional(TypesPaymentTerms$inboundSchema),

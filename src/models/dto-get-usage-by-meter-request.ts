...
/** @internal */
export const DtoGetUsageByMeterRequest$outboundSchema: z.ZodMiniType<
  DtoGetUsageByMeterRequest$Outbound,
  DtoGetUsageByMeterRequest
> = z.pipe(
  z.object({
    billingAnchor: z.optional(z.string()),
    ...
    windowSize: z.optional(TypesWindowSize$outboundSchema),
  }),
  z.transform((v) => {
    return remap$(v, {

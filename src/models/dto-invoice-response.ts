...
> = z.pipe(
  z.object({
    adjustment_amount: types.optional(types.number()),
    amount_due: types.optional(types.number()),
    amount_paid: types.optional(types.number()),
    amount_remaining: types.optional(types.number()),
    ...
    refunded_amount: types.optional(types.number()),
    ...
    subtotal: types.optional(types.number()),
    ...
    total_discount: types.optional(types.number()),
    total_prepaid_credits_applied: types.optional(types.number()),
    total_tax: types.optional(types.number()),

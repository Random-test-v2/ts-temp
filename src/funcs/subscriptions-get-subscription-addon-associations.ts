...
export function subscriptionsGetSubscriptionAddonAssociations(
  ...
  Result<
    Array<models.DtoAddonAssociationResponse>,
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.GetSubscriptionAddonAssociationsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(models.DtoAddonAssociationResponse$inboundSchema)),
